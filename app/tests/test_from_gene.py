...
def test_json_from_gene():
    expect = {'diseases': [{'disease_id': 'ORPHA:551', 'disease_name': 'MERRF',
              ...
              'phenotypes': [{'phenotype_id': 'HP:0000407',
                             ...
                             {'phenotype_id': 'HP:0001250', 'phenotype_name': 'Seizures'},
                             {'phenotype_id': 'HP:0001251', 'phenotype_name': 'Ataxia'},
                             {'phenotype_id': 'HP:0001257', 'phenotype_name': 'Spasticity'},
                             {'phenotype_id': 'HP:0001324', 'phenotype_name': 'Muscle weakness'},
                             {'phenotype_id': 'HP:0001336', 'phenotype_name': 'Myoclonus'},
                             {'phenotype_id': 'HP:0001427', 'phenotype_name': 'Mitochondrial inheritance'},
                             {'phenotype_id': 'HP:0002123', 'phenotype_name': 'Generalized myoclonic seizures'},
                             {'phenotype_id': 'HP:0002151', 'phenotype_name': 'Increased serum lactate'},
                             {'phenotype_id': 'HP:0003198', 'phenotype_name': 'Myopathy'},
                             {'phenotype_id': 'HP:0003200', 'phenotype_name': 'Ragged-red muscle fibers'},
                             {'phenotype_id': 'HP:0003542', 'phenotype_name': 'Increased serum pyruvate'},
                             {'phenotype_id': 'Orphanet:551', 'phenotype_name': 'MERRF'}],
              'variants': [{'chromosome': 'MT', 'dbsnp_id': 'rs199474700',
                            'disease_name': 'PARKINSON DISEASE, MITOCHONDRIAL (disorder)',
                            'ensembl_gene_id': 'ENSG00000210196', 'gene_name': 'TP',
                            'umls_disease_id': 'C1838867', 'variant': 'chrMT:15965A>G'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs199474701',
                            'disease_name': 'MERFF SYNDROME', 'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP', 'umls_disease_id': 'C4016625',
                            'variant': 'chrMT:15967G>A'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs375213730',
                            'disease_name': '', 'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP', 'umls_disease_id': '', 'variant': 'chrMT:15970T>C'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs201041059', 'disease_name': '',
                            'ensembl_gene_id': 'ENSG00000210196', 'gene_name': 'TP',
                            'umls_disease_id': '', 'variant': 'chrMT:15978C>T'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs199474699',
                            'disease_name': 'Myopathy', 'ensembl_gene_id': 'ENSG00000210196',
