...
async def test_get_vars_from_gene():
    expect = pd.DataFrame({
        ...
        "variant": ["NC_012920.1:m.7521G>A", "NC_012920.1:m.7526A>G",
                    "NC_012920.1:m.7547T>C", "NC_012920.1:m.7581T>C"],
    ...
    expect = {'diseases': [{'disease_id': 'ORPHA:551', 'disease_name': 'MERRF',
              ...
              'variants': [{'chromosome': 'MT', 'dbsnp_id': 'rs199474700',
                           ...
                           {'chromosome': 'MT', 'dbsnp_id': 'rs375213730',
                            ...
                            'variant': 'NC_012920.1:m.15970T>C'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs201041059', 'disease_id': '',
                            'disease_name': '',
                            'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP',
                            'umls_disease_id': '',
                            # 'variant': 'chrMT:15978C>T'},
                            'variant': 'NC_012920.1:m.15978C>T'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs199474699',
                            'disease_id': 'ORPHA:98472',
                            'disease_name': 'Myopathy',
                            'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP', 'umls_disease_id': 'C0026848',
                            # 'variant': 'chrMT:15990C>T'},
                            'variant': 'NC_012920.1:m.15990C>T'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs201864830', 'disease_id': '',
                            'disease_name': '',
                            'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP', 'umls_disease_id': '',
                            # 'variant': 'chrMT:16017T>C'},
                            'variant': 'NC_012920.1:m.16017T>C'},
                           {'chromosome': 'MT', 'dbsnp_id': 'rs55934780', 'disease_id': '',
                            'disease_name': '',
                            'ensembl_gene_id': 'ENSG00000210196',
                            'gene_name': 'TP', 'umls_disease_id': '',
                            # 'variant': 'chrMT:16023G>A'}]}
                            'variant': 'NC_012920.1:m.16023G>A'}]}
